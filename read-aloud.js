(() => {
  ...
  function updateToolbar() {
    ...
    if (main) {
      ...
      main.setAttribute('aria-label', `${main.textContent}，${currentVoiceName()}`);
  ...
  style.textContent = `
    ...
    .readAloudBar{position:relative;z-index:2;display:flex;justify-content:flex-end;align-items:center;gap:3px;max-width:720px;margin:0 auto;padding:5px 14px 0;border:0;background:transparent;backdrop-filter:none}
    .readAloudBar button{min-height:30px!important;padding:0 7px!important;border:0!important;border-radius:0!important;background:transparent!important;color:var(--muted)!important;font:inherit;font-size:10.5px!important;font-weight:650!important;box-shadow:none!important}
